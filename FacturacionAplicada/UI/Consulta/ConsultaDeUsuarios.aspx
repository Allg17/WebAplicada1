            ...
            <div class="row">
                <div class="col-md-4 col-sm-5 col-lg-2">
                    <asp:DropDownList ID="FiltroComboBox" runat="server" CssClass="form-control">
                        ...
                        <asp:ListItem Text="IdUsuario"></asp:ListItem>
                        <asp:ListItem Text="Nombre"></asp:ListItem>
                        <asp:ListItem Text="Clave"></asp:ListItem>
                        <asp:ListItem Text="NombreUsuario"></asp:ListItem>
                        <asp:ListItem Text="Comentario"></asp:ListItem>
                    </asp:DropDownList>
