<%@ Page Title="Entrada Articulo" Language="C#" MasterPageFile="~/UI/Registros/Master Page/Diseño.Master" AutoEventWireup="true" CodeBehind="RentradaArticulo.aspx.cs" Inherits="FacturacionAplicada.UI.Registros.rEntradaArticulo" %>
    ...
    <div class="container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="EntradaDropDownList" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
</asp:Content>
